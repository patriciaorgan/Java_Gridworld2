...
//initials are placed infront of all my own comments added "PO:"
...
public class Actor
{
    ...
    //PO: create a behviour object to be used for any actor.
    private Actorbehaviour actbehaviour;
    //PO: these behaviours will be initialised in teh constructor of the avious subclasses of actor 
    //PO: and the actor object itself will not have any behaviour other then it own already set act() method
    ...
    //PO: create getter and setter for the actbehaviour
    public Actorbehaviour getActbehave(){
    	return actbehaviour;
    }
    public void setActorBehaviour(Actorbehaviour act){
    	actbehaviour = act;
    }
    ...
    //PO: had to create an adapter like method in Actor so as to call the appripriate 
    //PO: actor behaviour class method
    public void move()
    {
    	//PO: passing the work of this method on to the behaviour class
    	actbehaviour.move(this);
    }
    ...
    {
    	//PO: passing the work of this method on to the behaviour class
    	return actbehaviour.canMove(this);
 
    }
    
    
    
     //PO: commenting out this code as putting this method now inside the Behaviours classes
    /*
