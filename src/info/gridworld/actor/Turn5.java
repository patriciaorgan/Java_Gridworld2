 ...
 */
public class Turn5 implements Actorbehaviour {

	/** PO:Moves the actor one step and then turns 225 degrees to the right
	 ...
	 public void moveTo(Actor actor, Location newLocation)
	    {
	        ...
	        /*PO: in order to mimick calling the turn method 5 times to make the bug 
	        * turn 45degrees 5 times before taking the next step
	        * the turn method in Bug class just calls the setDirection method, so we can 
	        * call this method instead direct from actor
	        * the direction the actor is currently going plus half_citcle and 
	        * half_right will bring it 225degrees
	        */
	        actor.setDirection(actor.getDirection() + Location.HALF_CIRCLE + Location.HALF_RIGHT);
